...
class ContenedorCarrito{
    ...
    try{
        ...
        try{
            ...
            return {statis:"error",message:"No se pudo cargar el producto"} 
        }
    }catch{
    ...
    async getById(idProducto){
        try {
            ...
            return {status:"error",message:"Error al traer el prodcuto"}
        }
    }
    ...
    async getAll(){
        try{
            ...
            return {status:"error",message:"Error al traer los productos. Intente más tarde"}
        }
    }
    ...
    async deleteById(id){
        try{
            ...
            try{
                ...
                return {status:"error", message:"El id del producto no existe"}
            }
        }catch{
    ...
    async deleteAll(){
        try{
            ...
            return{status:"error",message:"Error al querer borrar los productos"}
        }
    }
